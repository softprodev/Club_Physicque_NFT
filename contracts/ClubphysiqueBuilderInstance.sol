...
contract ERC721Metadata is Context, ERC165, ERC721, IERC721Metadata {
    ...
    */
   bytes4 private constant _INTERFACE_ID_ERC721_METADATA = 0x5b5e139f; // need to change
...
library Address {
   ...
   function isContract(address account) internal view returns (bool) {
       ...
       bytes32 codehash;
       bytes32 accountHash = 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470; // need to change
